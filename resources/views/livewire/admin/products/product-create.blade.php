<div>
    <form wire:submit="store">
        <figure class="mb-4 relative">
            ...
            <img src="{{ $image ? $image->temporaryUrl() : asset('img/no-image.jpeg') }}"
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-input type="number" class="w-full" placeholder="Precio del producto" step="0.01"
                    wire:model="product.price"></x-input>
            </div>
        </div>
