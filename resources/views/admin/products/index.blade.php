<x-admin-layout :breadcrumbs="[
    ...
    {{-- slot con nombre --}}
    <x-slot name="action">
        <a href="{{ route('admin.products.create') }}" type="button" class="btn btn-blue">Nuevo</a>
    </x-slot>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.products.edit', $product) }}" class="btn btn-blue">
                                    Editar
                                </a>
                            </td>
                        </tr>
    ...
    @else
        <div class="flex items-start sm:items-center p-4 mb-4 text-blue-900 text-fg-brand-strong rounded-base bg-blue-300"
            ...
            <p>Todavía no se han creado productos.</p>
        </div>
    @endif
</x-admin-layout>
